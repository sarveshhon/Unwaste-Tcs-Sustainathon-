...
import static com.teamunwaste.unwaste.Helper.API.SELL_PRODUCT_POST_API;
...
import com.teamunwaste.unwaste.databinding.FragmentSellBinding;
...
public class SellFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.btnSubmit.setOnClickListener(v -> {
            ...
            if(!etPT.equals("") && !etPD.equals("") && !etPP.equals("") && !etPN.equals("")) {
                if (binding.spinnerCategory.getSelectedItemPosition() != 0) {
                    String cid = acategoryId[binding.spinnerCategory.getSelectedItemPosition()];
                    uploadImage(cid);
                } else{
    ...
    private void sendData(String _categoryId, String _productTitle, String _productImage, String _productDescription, String _productPrice, String _productStatus, String _userName, String _userPhone, String _userEmail) {


        StringRequest request = new StringRequest(Request.Method.POST, SELL_PRODUCT_POST_API, response -> {
            ...
            protected Map<String, String> getParams() {
                ...
                hashMap.put(categoryId, _categoryId);
                hashMap.put(productTitle, _productTitle);
                hashMap.put(productImage, _productImage);
                hashMap.put(productDescription, _productDescription);
                hashMap.put(productPrice, _productPrice);
                hashMap.put(productStatus, _productStatus);
