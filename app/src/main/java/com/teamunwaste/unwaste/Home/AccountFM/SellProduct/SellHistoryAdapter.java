...
import static com.teamunwaste.unwaste.Helper.API.REMOVE_SELL_PRODUCT_HISTORY_API;
...
public class SellHistoryAdapter extends RecyclerView.Adapter<SellHistoryAdapter.ViewHolder> {
    ...
    public SellHistoryAdapter(Context context, List<ProductModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvProductDescription.setText(list.get(position).getProductDescription());
        holder.tvProductPrice.setText(context.getString(R.string.rupee)+" "+list.get(position).getProductPrice());

        holder.btnRemove.setOnClickListener(v -> {

            removeProduct(Util.convertMongodbObjToString(list.get(position).getProductId()));
            holder.btnRemove.setVisibility(View.GONE);
            Toast.makeText(context, "Product Removed"+Util.convertMongodbObjToString(list.get(position).getProductId()), Toast.LENGTH_SHORT).show();
    ...
    private void removeProduct(String _productID) {


        StringRequest request = new StringRequest(Request.Method.POST, REMOVE_SELL_PRODUCT_HISTORY_API, response -> {
            ...
            protected Map<String, String> getParams() {
                ...
                hashMap.put("productId", _productID);
